...
sal: bubble.o image.o aquarium.o background.o window.o fish.o
	$(CC) $(LDFLAGS) $^ -o $@
clean:
	rm -f sal *.o

aquarium.o: aquarium.c config.h sal.h fish.h background.h window.h bubble.h image.h
...
window.o: window.c window.h sal.h config.h
